  ...
  <div class="bg-gray-100 font-sans leading-normal tracking-normal">
    ...
    <div class="container w-full md:max-w-3xl mx-auto pt-6">
      ...
      >
        ...
        <span class="flex relative text-gray-600 text-base">
          {{ formatDate(article.updatedAt) }}
          <div class="absolute inset-y-0 right-0 mr-4">
            <a
              aria-label="Facebook"
              :href="`https://www.facebook.com/sharer/sharer.php?u=https://cintatic.com/blog/${article.slug}&title=${article.title}&description=${article.description}&quote=&hashtag=${article.hashtag}`"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
