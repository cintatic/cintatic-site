      ...
      <div class="flex flex-col lg:flex-row">
        ...
        <div class="grid gap-5 row-gap-5 sm:grid-cols-2">
          <div class="max-w-md">
            ...
            >
              <NuxtImg class="w-8" src="/icons/piggy-bank-solid.svg" />
            </div>
          ...
          <div class="max-w-md">
            <div
              class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50"
            >
              <NuxtImg class="w-8" src="/icons/compass-drafting-solid.svg" />
            </div>
          ...
          <div class="max-w-md">
            <div
              class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50"
            >
              <NuxtImg class="w-8" src="/icons/microchip-solid.svg" />
            </div>
          ...
          <div class="max-w-md">
            <div
              class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50"
            >
              <NuxtImg class="w-8" src="/icons/headset-solid.svg" />
            </div>
        ...
        <div class="space-y-6 sm:px-16">
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              ...
              >
                <NuxtImg class="w-8" src="/icons/google-brands.svg" />
              </div>
            </div>
            <div>
          ...
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              <div
                class="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50"
              >
                <NuxtImg class="w-6" src="/icons/lock-solid.svg" />
              </div>
            </div>
            <div>
          ...
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              <div
                class="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50"
              >
                <NuxtImg class="w-6" src="/icons/play-solid.svg" />
              </div>
            </div>
            <div>
          ...
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              <div
                class="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50"
              >
                <NuxtImg class="w-6" src="/icons/bolt-solid.svg" />
              </div>
            </div>
            <div>
          ...
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              <div
                class="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50"
              >
                <NuxtImg class="w-8" src="/icons/facebook-brands.svg" />
              </div>
            </div>
            <div>
          ...
          <div class="flex flex-col max-w-md sm:flex-row">
            <div class="mb-4 mr-4">
              <div
                class="flex items-center justify-center w-12 h-12 rounded-full bg-indigo-50"
              >
                <NuxtImg class="w-8" src="/icons/globe-solid.svg" />
              </div>
            </div>
            <div>
      ...
      <div class="max-w-screen-sm sm:text-center sm:mx-auto">
        ...
        >
          <div class="flex items-center justify-center w-16 h-16 mb-4">
            <NuxtImg class="text-2xl w-12" src="/icons/question-solid.svg" />
          </div>
        </a>
        <h2
